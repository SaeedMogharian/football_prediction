...
def build_handlers(service, admins, is_open):
    common_handlers = build_unknown_handler()
    user_handlers = build_user_handlers(service, is_open)
    admin_handlers = build_admin_handlers(service, admins, common_handlers["unknown"])
